...
var modalBtn = document.querySelector("#photographebutton");
var closeModalBtn = document.querySelector("#close"); // lancement modal
...
document.querySelector("#contact").addEventListener("submit", function (e) {
  ...
  var email = document.querySelector("#email"); //Regex

  var regex = /^[a-zA-ZÀ-ÖØ-öø-ÿ---_]+$/;
  var regexemail = /^\S+@\S+\.\S+$/;
  var errPrenom = document.querySelector("#erreur_prenom");
  var errNom = document.querySelector("#erreur_nom");
  var erremail = document.querySelector("#erreur_email");
